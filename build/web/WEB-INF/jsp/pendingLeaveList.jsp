...
<body>
 ...
 <table align="left" width="100%">
  ...
  <c:forEach items="${pendingLeaveList}" var="leave">
   <tr>
    ...
    <td><c:out value="${leave.status}"/></td>
                                <td><b><a href="<c:url value='/approveLeave/${leave.id}' />">View</a></b></td>
   </tr>
  </c:forEach>
 </table><br/>
</c:if>
