...
public class PageController
{
	...
	public String save(@Valid Page page, BindingResult bindingResult, Model model)
	{
	...
	public String getPageAssignment(Model model)
	{
		...
		model.addAttribute("allPageIds", allPageIds);
		model.addAttribute("pageListMap", this.pageService.getPageListMap());
